...
class SieuThuatToanV3 {
    ...
    capNhatLichSu(data) {
        ...
        for (const item of sortedData) {
            ...
            if (this.ketQuaHistory.length > 150) {
    ...
    phatHienBet() {
        ...
        if (doDai >= 3) {
            ...
            return { loai: `Bệt ${doDai}`, duDoan, doTinCay, key: 'bet' };
        }
        return null;
    }
    ...
    phatHienCau11() {
        ...
        if (la11) {
            ...
            return { loai: 'Cầu 1-1', duDoan, doTinCay: 78, key: 'cau11' };
        }
        return null;
    }
    ...
    phatHienCau22() {
        ...
        if (kq[0] === kq[1] && kq[2] === kq[3] && kq[0] !== kq[2]) {
            return { loai: 'Cầu 2-2', duDoan: kq[2], doTinCay: 80, key: 'cau22' };
        }
        return null;
    }
    ...
    phatHienCau33() {
        ...
        if (kq[0] === kq[1] && kq[1] === kq[2] &&
            kq[3] === kq[4] && kq[4] === kq[5] &&
            kq[0] !== kq[3]) {
            return { loai: 'Cầu 3-3', duDoan: kq[3], doTinCay: 84, key: 'cau33' };
        }
        return null;
    }
    ...
    phatHienCau121() {
        ...
        if (kq[0] !== kq[1] && kq[1] === kq[2] && kq[2] !== kq[3] && kq[0] === kq[3]) {
            return { loai: 'Cầu 1-2-1', duDoan: kq[0], doTinCay: 82, key: 'cau121' };
        }
        return null;
    }
    ...
    phatHienCau212() {
        ...
        if (kq[0] === kq[1] && kq[1] !== kq[2] && kq[2] !== kq[3] && kq[3] === kq[4] && kq[0] !== kq[3]) {
            return { loai: 'Cầu 2-1-2', duDoan: kq[3], doTinCay: 82, key: 'cau212' };
        }
        return null;
    }
    ...
    phatHienCauThang() {
        ...
        if (tang >= 3) return { loai: 'Cầu thang tăng', duDoan: 'Tài', doTinCay: 76, key: 'thang' };
        if (giam >= 3) return { loai: 'Cầu thang giảm', duDoan: 'Xỉu', doTinCay: 76, key: 'thang' };
        return null;
    }
    ...
    phanTichDiemSo() {
        ...
        if (lastDiem >= 14) return { loai: 'Điểm quá cao', duDoan: 'Xỉu', doTinCay: 72, key: 'diem' };
        if (lastDiem <= 7) return { loai: 'Điểm quá thấp', duDoan: 'Tài', doTinCay: 72, key: 'diem' };
        
        const avg5 = this.diemHistory.slice(0, 5).reduce((a,b) => a+b,0)/5;
        if (avg5 > 12) return { loai: 'Trung bình điểm cao', duDoan: 'Tài', doTinCay: 68, key: 'diem' };
        if (avg5 < 9) return { loai: 'Trung bình điểm thấp', duDoan: 'Xỉu', doTinCay: 68, key: 'diem' };
        return null;
    }
    ...
    phanTichBuTyLe() {
        ...
        if (tai20 >= 14) return { loai: `Bù tỷ lệ (Tài ${tai20}/20)`, duDoan: 'Xỉu', doTinCay: 74, key: 'bule' };
        if (tai20 <= 6) return { loai: `Bù tỷ lệ (Xỉu ${20-tai20}/20)`, duDoan: 'Tài', doTinCay: 74, key: 'bule' };
        return null;
    }
    ...
    phanTichMarkov() {
        ...
        if (tong >= 5) {
            if (taiSau / tong >= 0.7) return { loai: 'Markov → Tài', duDoan: 'Tài', doTinCay: 74, key: 'markov' };
            if (xiuSau / tong >= 0.7) return { loai: 'Markov → Xỉu', duDoan: 'Xỉu', doTinCay: 74, key: 'markov' };
        }
        return null;
    }
    ...
    phanTichXucXac() {
        ...
        if (maxFace >= 5) return { loai: `Xúc xắc ${maxFace} nhiều nhất`, duDoan: 'Tài', doTinCay: 66, key: 'xucxac' };
        if (maxFace <= 2) return { loai: `Xúc xắc ${maxFace} nhiều nhất`, duDoan: 'Xỉu', doTinCay: 66, key: 'xucxac' };
        return null;
    }

    // 12. Phân tích xu hướng 5 phiên
    phanTichXuHuong() {
        if (this.ketQuaHistory.length < 5) return null;
        const last5 = this.ketQuaHistory.slice(0, 5);
        const taiCount = last5.filter(r => r === 'Tài').length;
        if (taiCount >= 4) return { loai: 'Xu hướng Tài mạnh', duDoan: 'Xỉu', doTinCay: 70, key: 'xuhuong' };
        if (taiCount <= 1) return { loai: 'Xu hướng Xỉu mạnh', duDoan: 'Tài', doTinCay: 70, key: 'xuhuong' };
        return null;
    }
    ...
    phatHienCau44() {
        ...
        if (kq[0] === kq[1] && kq[1] === kq[2] && kq[2] === kq[3] &&
            ...
            kq[0] !== kq[4]) {
            return { loai: 'Cầu 4-4', duDoan: kq[4], doTinCay: 88, key: 'cau44' };
        }
        return null;
    }
    ...
    phatHienCau1221() {
        ...
        if (kq[0] !== kq[1] && kq[1] === kq[2] && kq[2] === kq[3] && kq[3] !== kq[4] && kq[0] === kq[4]) {
            return { loai: 'Cầu 1-2-2-1', duDoan: kq[0] === 'Tài' ? 'Xỉu' : 'Tài', doTinCay: 80, key: 'cau1221' };
        }
        return null;
    }
    ...
    duDoan() {
        ...
        doTinCay = Math.min(94, Math.max(60, Math.round(doTinCay)));
...
const predictor = new SieuThuatToanV3();
...
app.get('/', (req, res) => {
    res.json({
        name: 'SIÊU THUẬT TOÁN TÀI XỈU V3',
        version: '3.0',
        author: '@anhquan',
        features: ['14 loại cầu', 'Phân tích điểm', 'Markov', 'Tự học', 'Xúc xắc'],
...
app.get('/predict', async (req, res) => {
    ...
    res.json({
        ...
        chi_tiet: duDoan.chi_tiet.slice(0, 5),
...
app.listen(PORT, '0.0.0.0', async () => {
    console.log(`
╔══════════════════════════════════════════════════════╗
║   🎲 SIÊU THUẬT TOÁN TÀI XỈU V3 🎲                  ║
║   14 loại cầu | Markov | Tự học | Xúc xắc          ║
╚══════════════════════════════════════════════════════╝
    `);
