...
function analyzeMarkovChain(results, type) {
  ...
  // Xây dựng ma trận chuyển tiếp Markov
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('  4. Neural Boost - Mạng neuron 2 lớp ẩn');
  console.log('  5. Harmonic Pattern - Phát hiện sóng Elliott');
  console.log('  6. Sentiment Analysis - Phân tích tâm lý FOMO/Panic');
  console.log('  7. Wave Pattern - Phân tích cấu trúc sóng');
  console.log('  8. Golden Ratio - Tỷ lệ vàng Fibonacci');
  console.log('  9. Cập nhật ML model realtime sau mỗi kết quả');
  console.log('');
  console.log('FILE: tiendat.json, tiendat1.json');
  console.log('ID: @anhquan2011');
