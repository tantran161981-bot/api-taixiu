...
// === CẤU TRÚC LEARNING DATA CHO THUẬT TOÁN MỚI ===
let learningData = {
  hu: {
    totalPredictions: 0,
...
// === HÀM LẤY DỮ LIỆU API (GIỮ NGUYÊN TỪ FILE HOẠT ĐỘNG) ===
...
// === SUPER ADVANCED PREDICTION (THUẬT TOÁN CHÍNH) ===
...
app.get('/Resetdata', (req, res) => {
  learningData = {
    hu: { totalPredictions: 0, correctPredictions: 0, patternWeights: {}, markovMatrix: { T: { T: 0.5, X: 0.5 }, X: { T: 0.5, X: 0.5 } }, lastResults: [], streakAnalysis: { currentStreak: 0 }, predictions: [], patternStats: {}, lastUpdate: null, recentAccuracy: [], reversalState: { active: false, streakTrigger: 0 }, markov2Matrix: {}, volatility: 0 },
    md5: { totalPredictions: 0, correctPredictions: 0, patternWeights: {}, markovMatrix: { T: { T: 0.5, X: 0.5 }, X: { T: 0.5, X: 0.5 } }, lastResults: [], streakAnalysis: { currentStreak: 0 }, predictions: [], patternStats: {}, lastUpdate: null, recentAccuracy: [], reversalState: { active: false, streakTrigger: 0 }, markov2Matrix: {}, volatility: 0 }
  };
  saveLearningData();
...
app.listen(PORT, '0.0.0.0', () => {
  ...
  console.log('✅ Dùng thuật toán Super Advanced Prediction');
  startAutoSaveTask();
});
